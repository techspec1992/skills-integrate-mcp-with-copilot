...
def signup_for_activity(activity_name: str, email: str, _: str = Depends(authenticate_teacher)):
...
def unregister_from_activity(activity_name: str, email: str, _: str = Depends(authenticate_teacher)):
